...
public final class VirtualWorld extends PApplet {
    ...
    public void mousePressed() {
        ...
        String id = "Person" + pressed.x + "_" + pressed.y;
        AmongUs amogus = Factory.createAmog(id, pressed, 0.100, 0.100, imageStore.getImageList("amog"));
        world.tryAddEntity(amogus);
        amogus.scheduleActions(scheduler, world, imageStore);
        SoundPlayer.playSound("sus.wav");
